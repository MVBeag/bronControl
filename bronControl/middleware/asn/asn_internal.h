...
#define	CALLOC(nmemb, size)	bsp_calloc(nmemb, size)
#define	MALLOC(size)		bsp_malloc(size)
#define	REALLOC(oldptr, size)	bsp_realloc(oldptr, size)
#define	FREEMEM(ptr)		bsp_free(ptr)
